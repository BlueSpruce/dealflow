...
export const testPost = (field1='id',value1='a2302ef8-3e86-4358-979e-18eb3ce7c9d6',field,value) => {
  console.log('http.js testPost() '+[field,value])
  let testObj ={field1:value1,field:value}
  const options = {
     "method": "POST",
    "headers": requestHeaders,
    "body": JSON.stringify({id:value1, CustomField6:value}),
  }
return fetch(`${Constants.routes.api}custom-field-value?api-token=${toke}`,
     options);
};
...
var settings = {
  "async": true,
  "crossDomain": true,
  "url": "https://insight.bluesprucecapital.net/api/custom-field-value?api-token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJpYXQiOjE1MDE1MTM5NzAsImV4cCI6MTU4MDQ1NDAwMCwic3ViIjoiM2I0NmFlOTUtM2NkOC00YzU0LTljNzctMmQ2YjU0MjNhOGE2In0.q2k-FP9iJ7SruHAHxQaU3CxK8-K8k74chJ_mYA7JkuFsdRwiqPpgOD9hgJFQLHZ7NeBnB43t9Wf_1AZQ3VNMRw",
  "method": "POST",
  "headers": {
    "authorization": "Basic anBvd2VyQGJsdWVzcHJ1Y2VjYXBpdGFsLmNvbTpCTHVlc3BydWNlMjAxNw==",
    "content-type": "application/json",
    "cache-control": "no-cache",
    "postman-token": "af0dd8cf-388d-9e81-9c6e-e66c15907a1e"
  },
  "data": "{id: \"a2302ef8-3e86-4358-979e-18eb3ce7c9d6\",\nCustomField6: \"Testing1231\"\n}"
}
...
export const postsData = () => {
  ...
  testPost('id','a2302ef8-3e86-4358-979e-18eb3ce7c9d6','CustomField6','valueTest12a')
