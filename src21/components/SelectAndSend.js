...
class SelectAndSend extends Component {
  ...
  handleCreate(data, selection) {
    ...
    //this.href = "mailto:you@yourdomain.com?subject=Data&body=bodytext";
  }
        ...
        <div>
          ...
          <div style={{ padding: "20px" }}>
            ...
            <Mailto
              ...
              obfuscate={true}
              headers={{
                subject: "HEY THERE IS A NEW DEAL FLOW DOCUMENT IN BOX COM",
                body: `"Guess what? \n There is a new document in box.com.  \n\nHere i link to that shared box.com folder "+${this
                  .state.test}`
              }}
            >
              <RaisedButton
