    ...
    return (
      <div>
        <form style={{ padding: 20 }}>
          ...
          <TextField
            hintText="Required MIN capital"
            floatingLabelText="Required MIN capital"
            name=""
            value={selectedObj.dealname}
            onChange={this.handleChange}
          />
          <TextField
            hintText="Required MAX capital"
            floatingLabelText="Required MAX capital"
            name=""
            value={selectedObj.dealname}
            onChange={this.handleChange}
          />
