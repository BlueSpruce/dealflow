...
class DealForm extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <h2 style={{ color: this.props.muiTheme.palette.primary2Color }}>
          {dataTextDealName[0].value}
        </h2>
        <FlatButton
        ...
        {this.state.tab == "b" && (
          <Tab2 selectedObj={this.props.selectedObj} f={this.props.f} />
        )}

        {this.state.tab == "c" && (
          <Tab3 selectedObj={this.props.selectedObj} f={this.props.f} />
        )}

        {this.state.tab == "d" && (
          <Tab4 selectedObj={this.props.selectedObj} f={this.props.f} />
        )}
      </div>
    );
  }
