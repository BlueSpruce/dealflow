    ...
    return (
      <div style={{padding:20}}>
          ...
          <SelectField
            ...
            style={{ height: 87 }}
          >
            {this.menuItems(selectSubTypeInvestment, selectedObj.investmentSubType)}
          </SelectField>
          ...
          <TextField
            ...
            name="minCapital"
            value={selectedObj.minCapital ? numberAddCommas(selectedObj.minCapital) : ''}
          ...
          <TextField
            ...
            name="maxCapital"
            value={selectedObj.maxCapital ? numberAddCommas(selectedObj.maxCapital) : ''}
            onChange={this.handleCurrencyChange}
          />
          <TextField
            ...
            value={selectedObj.capitalCommitted ? numberAddCommas(selectedObj.capitalCommitted): ''}
            onChange={this.handleCurrencyChange}
          />
          <DatePicker
